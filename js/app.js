...
const MSDS = {
  ...
  '신나': { cas:'혼합물', formula:'Mixture (톨루엔·크실렌 등)', name:'신나 (Thinner)', un:'UN1263', signal:'위험',
    hazard:['고인화성 액체 및 증기 (H225/H226)','졸음 또는 현기증을 일으킬 수 있음 (H336)','눈·피부·호흡기 자극','장기간·반복 노출 시 중추신경계·장기 손상 우려'],
    handling:'화기 엄금(금연), 방독마스크·보호장갑·보안경 착용, 국소배기·환기, 정전기 방지 및 접지',
    storage:'환기되는 냉암소에 단단히 밀폐, 점화원·산화제와 격리, 저온 유지' },
  '프라이머': { cas:'혼합물', formula:'Mixture (수지·용제계)', name:'프라이머 (Primer, 도료)', un:'UN1263', signal:'위험',
    hazard:['인화성 액체 및 증기 (H226)','졸음 또는 현기증을 일으킬 수 있음 (H336)','눈·피부·호흡기 자극','용제 증기 장기 노출 시 건강장해 우려'],
    handling:'화기 엄금, 방독마스크·보호장갑·보안경 착용, 도장부스 환기 가동, 정전기 방지',
    storage:'환기되는 냉암소에 밀폐, 점화원·산화제와 격리' },
  '우레탄 도료': { cas:'혼합물', formula:'Mixture (이소시아네이트 함유)', name:'우레탄 도료 (Urethane paint)', un:'UN1263', signal:'위험',
    hazard:['인화성 액체 및 증기 (H226)','흡입 시 알레르기성 천식·호흡곤란을 일으킬 수 있음 (이소시아네이트) (H334)','피부·호흡기 과민성 (H317)','졸음 또는 현기증을 일으킬 수 있음 (H336)'],
    handling:'화기 엄금, 유기증기용 방독마스크·보호의·보호장갑 착용, 도장부스 환기, 분무 시 미스트 흡입 차단',
    storage:'환기되는 냉암소에 밀폐, 수분·점화원·산화제와 격리' },
  '경화제': { cas:'혼합물', formula:'Mixture (이소시아네이트·아민계)', name:'경화제 (Hardener)', un:'-', signal:'위험',
    hazard:['흡입 시 알레르기성 천식·호흡곤란을 일으킬 수 있음 (H334)','피부·눈에 자극 또는 화상','피부·호흡기 과민성 (H317)','장기간·반복 노출 시 호흡기 손상'],
    handling:'유기증기용 방독마스크·보호의·내화학성 장갑·보안경 착용, 국소배기·환기, 혼합 시 미스트·증기 흡입 차단',
    storage:'수분을 피해 밀폐, 서늘하고 환기되는 곳, 산·알칼리·산화제와 격리' },
